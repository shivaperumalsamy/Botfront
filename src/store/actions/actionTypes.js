...
export const GET_MESSAGETONE_STATE = 'GET_MESSAGETONE_STATE';
...
export const TOGGLE_MESSAGETONE = 'TOGGLE_MESSAGETONE';
...
export const ADD_CUSTOM_CAROUSEL = 'ADD_CUSTOM_CAROUSEL';
export const ADD_CUSTOM_CARD = 'ADD_CUSTOM_CARD';
export const ADD_CUSTOM_DATA_TABLE = 'ADD_CUSTOM_DATA_TABLE';
export const ADD_CUSTOM_ACCORDION = 'ADD_CUSTOM_ACCORDION';
